...
export const workoutDays: WorkoutDay[] = [
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        muscle: "Glutes",
        gifUrl: "https://static.exercisedb.dev/media/S0x3411.gif",
        sets: 3,
        targetRepsMin: 8,
        targetRepsMax: 12,
      },
      ...
      },
      {
        ...
        muscle: "Lower Abs",
        gifUrl: "https://static.exercisedb.dev/media/TJBlaXq.gif",
        sets: 3,
        targetRepsMin: 8,
        targetRepsMax: 12,
      },
  ...
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        muscle: "Front Delts",
        gifUrl: "https://static.exercisedb.dev/media/umBmRvN.gif",
        sets: 3,
        targetRepsMin: 8,
        targetRepsMax: 12,
      },
  ...
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        muscle: "Back (Thickness)",
        gifUrl: "https://static.exercisedb.dev/media/8NbMEYA.gif",
        sets: 3,
        targetRepsMin: 8,
        targetRepsMax: 12,
      },
