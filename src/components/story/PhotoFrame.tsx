...
// Shows a photo with a soft, framed look. If the image is a placeholder path
// (or fails to load), it falls back to an elegant empty frame so the layout
// always looks intentional before real photos are added.
  ...
  return (
    ...
    >
      <div className="relative aspect-[4/5] w-full overflow-hidden rounded-[14px] bg-[#F6E9E6]">
        {showFallback ? (
          <div className="flex h-full w-full flex-col items-center justify-center gap-2 bg-gradient-to-br from-[#F8E4E1] to-[#EFD9D2] text-[#C99] ">
